...
content = '''const mockStore = require("../utils/mockStore.js");
...
pathlib.Path(r'd:\微信小程序开发平台\ring\项目文件夹\miniprogram\services\mockAiService.js').write_text(content, encoding='utf-8')
